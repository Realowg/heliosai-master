...
# Step 1: Install Heliod-Roo-Code dependencies
print_message "Installing Heliod-Roo-Code dependencies..."
cd "$ROOT_DIR/Heliod-Roo-Code" || handle_error "Could not navigate to Heliod-Roo-Code directory"
npm run install:all || handle_error "Failed to install Heliod-Roo-Code dependencies"
print_message "Heliod-Roo-Code dependencies installed successfully!"

# Step 2: Install and build Heliod submodule
print_message "Installing and building Heliod submodule..."
cd "$ROOT_DIR/heliod-submodule" || handle_error "Could not navigate to heliod-submodule directory"
...
cd "$ROOT_DIR/heliod-app" || handle_error "Could not navigate to heliod-app directory"
